...
class CategoryField extends StatefulWidget {
  // category type current support [textCategory, expandCategory, listCategory, selectedCategory]
  final CategoryType categoryType;
  // padding around category field
  final double? marginLeft;
  final double? marginRight;
  final double? marginTop;
  final double? marginBottom;
  // Spacing between item in list category
  final double? spacingItem;
  // Number row support for grid category
  final int? numberColumn;
  // list items
  final List<CategoryStyle> categories;
  // Icon in or icon out field category item field
  final bool isIconOut;
  // Set color for category
  final Color? selectedColor;
  final Color? unselectedColor;
  // Category grid format support for expand category
...
class CategoryStyle {
  // Text
  final String text;
  // Url for image asset, svg asset, net
